...
SECRET_KEY = 'django-insecure-x=kgmv+(9h9@^*15d7g03v1$sx^=y2h!oxkgifa*p4+76*j@l)'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'MiProyecto/static')] #Me volvio loca, no oplvidar la S en Staticfiles
